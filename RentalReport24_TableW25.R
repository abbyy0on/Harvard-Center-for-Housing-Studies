#Table W25: Share of Housing Cost-Burdened Renters, 2012-2022
...
#export to excel-------
title <- "Table W-25. US Metro Areas: Share of Housing Cost-Burdened Renters: 2012-2022" #update the year
...
writeData(wb, sheet = "W-25", x = title, #pastes the title in to cell A1
          startCol = 1, startRow = 1, colNames = FALSE)
writeData(wb, sheet = "W-25", x = burdens_us_table,
...
writeData(wb, sheet = "W-25", x = burdens_met_table, 
          startCol = 1, startRow = 8, colNames = FALSE)
writeData(wb, sheet = "W-25", x = sources, 
